...
class User implements AdvancedUserInterface, \Serializable
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\TempOrder", mappedBy="user")
     */
    private $temp_user_orders;
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\AnswersGiven", mappedBy="user")
     */
    private $answers;
    ...
    /**
     * @param mixed $googleLogin
     */
    public function setGoogleLogin($googleLogin): void
    {
     ...
     * @return mixed
     */
    public function getTempUserOrders()
    {
        return $this->temp_user_orders;
    }

    /**
     * @param mixed $temp_user_orders
     */
    public function setTempUserOrders($temp_user_orders): void
    {
        $this->temp_user_orders = $temp_user_orders;
    }
    ...
    /**
     * @param mixed $user_orders
     */
    public function setUserOrders($user_orders): void
    {
